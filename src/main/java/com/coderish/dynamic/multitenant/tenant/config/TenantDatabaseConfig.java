package com.coderish.dynamic.multitenant.tenant.config;
...
@ComponentScan(basePackages = { "com.coderish.dynamic.multitenant.tenant.repository", "com.coderish.dynamic.multitenant.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.coderish.dynamic.multitenant.tenant.repository", "com.coderish.dynamic.multitenant.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.coderish.dynamic.multitenant");
